...
from hdr_toolkit.networks import (ADNet, ECADNet, PSFTDNet, AHDRNet, BAHDRNet, ResRefAHDR, ResRefSFTNet, ResRefDANet, FDANet)
...
a = FDANet(64, '../models/spy_net/ckpt.pth', out_activation='sigmoid')
